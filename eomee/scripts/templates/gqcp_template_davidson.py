...
def OODOCI_calculation(N_P, basis, hamiltonian, fname):
    ...
    eigenvals = qc_structure_davidson.groundStateEnergy() + nuc_rep
    eigenvecs = qc_structure_davidson.groundStateParameters().coefficients()
    ci_parameters = qc_structure_davidson.parameters()
    ...
    return eigenvals, eigenvecs, ci_parameters
